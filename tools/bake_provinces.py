...
def bake_list_dispatch(regions):
    """State scope in, scope:actor holds the list."""
    out = [HEADER, 'mbga_fill_selectable_provinces = {' + NL,
           '	scope:actor = { clear_variable_list = mbga_selectable }' + NL]
    first = True
    for name in sorted(regions):
        ...
        out.append('			scope:actor = { add_to_variable_list = { name = mbga_selectable'
